        ...
        <div class="container">
            ...
            <div class = "nav-collapse collapse navbar-responsive-collapse">
                <ul class = "nav navbar-nav">
					...
					<li><a href = "#">Selling Section</a></li>
					<li><a href = "#">Search Section</a></li>
					<li><a href = "#">Message Section</a></li>
					<li><a href = "#">Enter Book Details</a></li>
					<li><a href = "#">Enter Publisher Details</a></li>
					<li><a href = "#">Enter Client Details</a></li>
                </ul>
                  <ul class = "nav navbar-nav pull-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"> Stock_Keeper<strong class="caret"></strong></a>
