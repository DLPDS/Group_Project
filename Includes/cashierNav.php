        ...
        <div class="container">
            ...
            <div class = "nav-collapse collapse navbar-responsive-collapse">
                <ul class = "nav navbar-nav">
					...
					<li><a href = "addSale%20-%20Cashier.html">Bills</a></li>
					<li><a href = "../PHP/Search.php">Books</a></li>
					<li><a href = "returnedBooks.html">Returned Books</a></li>
                    <li><a href = "#">Sales</a></li>

                </ul>
                  <ul class = "nav navbar-nav pull-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"> CASHIER<strong class="caret"></strong> </span></a>
